...
abstract contract ContractAddresses {
    address usdcBtcLink = 0x6ecF9bBf7038c6Ca131fC73197B89993942eb5bb;
    ...
    IManagerIssuanceHook managerIssuanceHookAddress =
        IManagerIssuanceHook(address(0));
    IController controllerAddress =
        IController(0x9Df9fef12Fa512315CC9F3e5C1D2faFf1bB04a72);
    IIntegrationRegistry integrationRegistryAddress =
        IIntegrationRegistry(0x2Fb11ea7CEE5e62E4709BB7BE420C4EaBfA3ea0A);
    ISetTokenCreator setTokenCreatorAddress =
        ISetTokenCreator(0x7c4Bb129E929A955e36137144607Fb32be52b804);
    ISetValuer setValuerAddress =
        ISetValuer(0x012d6bC94051C3b9F923c043A51D381903EAC16A);
    IPriceOracle priceOracleAddress =
        IPriceOracle(0x49ad1B642318202A5b20513B826918A328D8D6E4);
    IBasicIssuanceModule basicIssuanceModuleAddress =
